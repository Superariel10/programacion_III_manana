...
export declare class UsersController {
    ...
    findAll(page?: number, limit?: number, search?: string, searchField?: string, sortBy?: string, sortOrder?: 'ASC' | 'DESC'): Promise<SuccessResponseDto<Pagination<User, import("nestjs-typeorm-paginate").IPaginationMeta>>>;
